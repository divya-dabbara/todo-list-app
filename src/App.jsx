...
function App() {
  ...
  return (
    <>
      <Navbar />
      <div className="md:container mx-auto bg-violet-100 my-5 rounded-xl p-5 min-h-[80vh] md:w-[35%]">
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <div className="flex">
            ...
            <button
              ...
              className="bg-violet-950 disabled:bg-violet-700 hover:bg-violet-950 p-4 py-2 text-sm font-bold text-white rounded-full cursor-pointer mx-2"
            >
              Save
            </button>
          </div>
